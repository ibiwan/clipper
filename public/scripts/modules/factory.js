...
define(['jquery', 'mustache'], function ($, Mustache) {
    ...
    function contentImage(_id, type, filename) {
        ...
        img.data('activate', function () {
            img.attr('src', img.data('src'));
        });
        img.data('clone', function () {
            return contentImage(_id, type, filename);
        });
        return img;
    }
    ...
    function contentPdf(_id, filename) {
        ...
        pdf.data('activate', function () {
            pdf.attr('data', pdf.data('data'));
        });
        pdf.data('clone', function () {
            return contentPdf(_id, filename);
        });
        return pdf;
    }
